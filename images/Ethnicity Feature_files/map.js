    ...
    chartMap.legend
      ...
      .attr("y",function(d){
        if ((IS_PHONE) || (IS_MOBILE)) {
          return 2*legend_scale_y*legend_mobile_scale_y + "em"
        } else {
          return "2em"
        }
      })
...
/*THIRD*/
    chartMap.legend
      ...
      .attr("y",function(d){
         if ((IS_PHONE) || (IS_MOBILE)) {
          return 3*legend_scale_y*legend_mobile_scale_y + "em"
        } else {
          return "2em"
        }
      })
...
/*FOURTH*/
    chartMap.legend
      ...
      .attr("y",function(d){
        if ((IS_PHONE) || (IS_MOBILE)) {
          return 4*legend_scale_y*legend_mobile_scale_y + "em"
        } else {
          return "2em"
        }
      })
...
/*FIFTH*/
    ...
    chartMap.legend.append("text")
      ...
      .attr("x", function() {
       ...
       .attr("y",function(d){
       if ((IS_PHONE) || (IS_MOBILE)) {
          return 7.9*legend_scale_y*legend_mobile_scale_y + "em"
        } else {
          return "3.7em"
        }
      })
