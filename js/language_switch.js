...
var HEADERTEXT = {
  ...
  <p>Una encuesta de información de justicia penal del estado indicó que 40 estados reportaban raza (\por ejemplo, &ldquo;blanca&rdquo;, &ldquo;negra&rdquo;, &ldquo;otra&rdquo;) en sus registros de arresto, pero solo 15 estados reportaban el origen étnico. Aunque los latinos son solo uno de los muchos grupos étnicos en los Estados Unidos, se predice que la población general \
   será 28,6 por ciento latino en el 2060 y los latinos son el grupo más afectado cuando los estados no consideren el origen étnico. </p>\
  Evidencia muestra que nuestro sistema de justicia penal tiene \
  disparidades considerables raciales. Pero, sin información completa, los legisladores, los miembros de la comunidad y los defensores no pueden saber cómo es que la encarcelación en masa afecta específicamente a los latinos y no puede hacerse un seguimiento en forma precisa de las disparidades del origen étnico. </p>\
   <p>El incumplimiento del estado de recoger y reportar información sobre el origen étnico no solo afecta a los latinos, sino a todo el sistema de justicia penal. Los estados solo cuentan a las personas como \"negra\" o \"blanca\", probablemente etiquetando a la mayor parte de su población penitenciaria latina como \"blanca\"\
...
var FIRSTSECTION ={
  ...
  spanish:["<h1>Pocos estados incluyen a los latinos en la mayor parte de su información de justicia penal.</h1> <p>Hemos realizado un seguimiento a toda la información sobre raza y origen étnico que pudimos encontrar a través de fuentes disponibles para el público y fácilmente accesibles para cada estado y Washington, DC, en las siguientes cinco categorías: población penitenciaria, población penitenciaria por delito, arrestos, población en libertad condicional y población en libertad bajo palabra. \
  </p> <p> Solo un estado, Alaska, incluía información de manera consistente sobre latinos en informes publicados recientemente y regularmente sobre arrestos y prisión, libertad condicional y libertad bajo palabra. Aunque es posible que más estados recopilen esta información de forma rutinaria, solo consideramos información que los estados pusieron disponible al público. El setenta y cinco por ciento de los estados reportaron información recientemente y regularmente por origen étnico en por lo menos una de nuestras cinco categorías, \
...
var SECONDSECTION = {
  ...
  spanish: ["<p>También analizamos la <em>calidad</em> de la información sobre origen étnico de los estados. Existe un desacuerdo en esta esfera sobre cómo colectar información de raza y origen étnico, y si esas deben ser categorías separadas.\
  Muchos latinos consideran su raza hispana o latina, en lugar de identificarse racialmente como blanco o negro, y étnicamente como latino o hispano. Cuando evaluamos la calidad de la información demográfica, seguimos la política federal actual y las definiciones de la Oficina del Censo en relación a \
  raza y origen étnico, las cuales les permiten a los latinos identificarse tanto como hispanos y también como de una raza especifica.</p>\
  ...
  <p>Los estados incluyeron latinos en su información de población penitenciaria mucho más que en las otras categorías de información a la que realizamos seguimiento. Treinta y ocho estados reportaron información sobre latinos en prisión, en comparación con solo 20 que reportaron información sobre latinos en la población con libertad bajo palabra, 18 que reportaron información sobre latinos en la población con libertad condicional, 15 que reportaron información sobre latinos en registros de arresto y solo 1 que reportó información sobre latinos en prisión por delito.</p>\
  <p>Casi ningún estado reportó información sobre latinos en categorías combinadas (por ejemplo, &ldquo;hispano blanco&rdquo; o &ldquo;no hispano negro&rdquo;). Solo tres– Nuevo Hampshire, Carolina del Norte y Vermont–hicieron seguimiento tanto a la raza como al origen étnico y lo reportaron en combinación con cualquier otra categoría de información (población penitenciaria en Carolina del Norte y arrestos en Nuevo Hampshire y Vermont).</p>"]
}
...
var THIRDSECTION = {
  ...
  spanish: ["<h1>Los estados con grandes poblaciones latinas no necesariamente tienen mejor información.</h1> \
      <p>El setenta y cinco por ciento de latinos en Estados Unidos viven en solo 10 estados. Muchos de estos estados tienen considerables brechas en la información reportada sobre origen étnico, a pesar de sus grandes poblaciones latinas. California, Florida y Nuevo México, por ejemplo, reportaron información sobre origen étnico en menos categorías que el promedio observado entre estados. \
      </p> <p>El informe de los datos en estos estados es especialmente importante, ya que es probable que los estados con más residentes latinos tengan más latinos en sus sistemas de justicia penal. Los efectos de las políticas del sistema de justicia penal sobre los latinos pueden pasar desapercibidos por el público y por los legisladores en los estados en los cuales las agencias no reportan información sobre origen étnico. </p>"]
}
...
var CONCLUSION ={
  ...
  spanish:["<h1 class=\"last-header\">Estableciendo un estándar de información más alto</h1>\
    <p>La información importa porque afecta las políticas. Hemos visto esto en todo el país ya que el incremento del seguimiento de los disparos de la policía,\
    alimentado en parte por la muerte de Michael Brown en el 2014 en Ferguson, Misuri, provocó un discurso nacional acerca de las relaciones entre la comunidad y la policía.\
    ...
    <p>La recopilación y el informe de los datos en el sistema de justicia penal es inconsistente e incompleto. Presentamos las siguientes recomendaciones para mejorar la calidad y la utilidad de la información sobre raza y origen étnico:\
    ...
    <li>La información debe recogerse y reportarse públicamente por lo menos cada dos años. Esto ofrecería información más frecuente sobre latinos, uno de los grupos demográficos creciendo más rápido en el país.</li>\
    ...
    </p>Si los estados siguen los cambios censales para el 2020, propuestos por el gobierno nacional y combinan raza y \
    origen étnico en una pregunta, se les debe permitir a las personas involucradas en el sistema de justicia marcar más de una casilla. Y, aunque los estados deberían por lo menos incluir una categoría de &ldquo;hispano&rdquo; o &ldquo;latino&rdquo;, los latinos no son un monolito. \
     Muchos latinos se identifican como de raza mixta, indígenas o afrolatinos. El origen étnico hispano o latino puede dividirse aún más \
     por país de origen (por ejemplo, mexicano o cubano).</p>\
...
var DISCLAIMER = {
  english: [],
  spanish: ["Nota: La versión en inglés de este artículo contiene enlaces a contenido que no están disponibles en español."]
}
...
var FOOTER_TEXT = {
  ...
  spanish: ["<h2>Acerca de la información</h2><p>Recopilamos la información utilizada en esta presentación de fuentes a nivel estatal disponible para el público en los 50 estados y Washington, DC. Además de un análisis de los sitios de web de agencias estatales, revisamos los resultados de búsqueda de Google para cada categoría de información y cada estado, utilizando términos de búsqueda enfocados en informes anuales, estadísticas, raza y origen étnico. De eso, creamos una base de datos de la información más reciente y \
  completa que era disponible. La recopilación de información se realizó entre junio y septiembre del 2016 y todas las fuentes utilizadas en esta presentación estaban disponibles durante ese periodo. Es posible que la información encontrada utilizando nuestro protocolo de búsqueda no refleje toda la información recopilada o reportada por cada estado, agencia o departamento.</p>\
  <p>Se considera que los estados incluyen a los latinos en su informe de datos cuando su informe demográfico racial o étnico incluye categorías como &ldquo;hispano&rdquo; o &ldquo;latino&rdquo;. Los latinos pueden ser reportados como un grupo étnico o racial distinto o combinado con un grupo racial (por ejemplo, &ldquo;hispano negro&rdquo; o &ldquo;no hispano blanco&rdquo;). Reconocemos que &ldquo;hispano&rdquo; y &ldquo;latino&rdquo; tienen significados distintos. Esta presentación utiliza &ldquo;latino&rdquo; cuando \
  se refiere a personas, comunidades o poblaciones e &ldquo;hispano&rdquo; cuando se refiere a información, ya que es el término que la mayoría de estados utiliza cuando reportan información.</p>\
  <p>Definimos la información reportada recientemente y regularmente como información reportada públicamente por lo menos dos veces, por lo menos cada dos años y por lo menos en el 2014.</p> \
